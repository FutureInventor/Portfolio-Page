			...
			<div className={styles.content}>
					...
					<div className={styles.hobbies}>
						...
						<div className={styles.commissions}>
							...
							<h2>
								...
								treat it as my hobby, taking small graphical project from time
								to time.
							</h2>
							<div className={styles.scrollGallery}>
								<div className={styles.hint}>Sroll right to see more</div>
								<Image
				...
				<Fade>
					<div className={styles.photoGallery}>
						<h1>Photo Gallery</h1>
						<h2>
							I do believe that <s>actions</s> images speak louder than words.
							By looking at the pictures below, you can get a little grasp of
