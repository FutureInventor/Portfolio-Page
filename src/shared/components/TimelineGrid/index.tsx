	...
	<div className={styles.timelineGrid}>
		...
		<div className={styles.timelineGridItemCard}>
			...
			<div className={styles.cardContent}>
				...
				<p className={styles.cardContentDescription}>
					...
					Design Graphic Applications, The Basics of Building of Neural Network.
					<br />
		...
		<div className={styles.timelineGridItemCard}>
			<div className={styles.cardContent}>
				...
				<p className={styles.cardContentDescription}>
					Building on my own a responsive web application, which had a catalogue
					of all company's servers, displayed in the tree structure. Server's
					data was taken and parsed from XML file to JSON. Anyone logged could
					browse through lists of servers. Search and sort by name function were
					applied. App had system of accounts as well. Admins, technical and
					user ones. Admins could manage accounts by editing them, deleting and
					authorize (every new user had to be authorized by admin). Admins could
					also see what user is logged at the moment.
					<br />
					<br />
		...
		<div className={styles.timelineGridItemCard}>
			<div className={styles.cardContent}>
				...
				<p className={styles.cardContentDescription}>
					...
					<br />
					-building a 'light' version of main application that could be inserted
					into an iframe and creating an API via those two elements could
					communicate,
					<br />
					...
					workflow noticeably,
					<br />
					-constructing complete translation system which let the user to change
					language of application (if not chosen, language was detected
					automatically).
					<br />
